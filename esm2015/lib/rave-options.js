...
function _RaveOptions_tsickle_Closure_declarations() {
    /**
     * Your merchant public key provided when you create a button
     * @type {?}
     */
    _RaveOptions.prototype.PBFPubKey;
    /**
     * Email of the customer
     * @type {?}
     */
    _RaveOptions.prototype.customer_email;
    /** @type {?} */
    _RaveOptions.prototype.payment_plan;
    /**
     * Firstname of the customer
     * @type {?}
     */
    _RaveOptions.prototype.customer_firstname;
    /**
     * firstname of the customer
     * @type {?}
     */
    _RaveOptions.prototype.customer_lastname;
    /**
     * Text to be displayed as a short modal description
     * @type {?}
     */
    _RaveOptions.prototype.custom_description;
    /**
     * Link to your custom image
     * @type {?}
     */
    _RaveOptions.prototype.custom_logo;
    /**
     * Text to be displayed as the title of the payment modal
     * @type {?}
     */
    _RaveOptions.prototype.custom_title;
    /**
     * Amount to charge
     * @type {?}
     */
    _RaveOptions.prototype.amount;
    /**
     * phone number of the customer
     * @type {?}
     */
    _RaveOptions.prototype.customer_phone;
    /**
     * URL to redirect to when transaction is completed.
     * @type {?}
     */
    _RaveOptions.prototype.redirect_url;
    /**
     * route country. Default NG
     * @type {?}
     */
    _RaveOptions.prototype.country;
    /**
     * currency to charge the card in. Default "NGN"
     * @type {?}
     */
    _RaveOptions.prototype.currency;
    /**
     * This allows you select the payment option you want for your users, possible values are card, account or both
     * @type {?}
     */
    _RaveOptions.prototype.payment_method;
    /**
     * Text to be displayed on the Rave Checkout Button
     * @type {?}
     */
    _RaveOptions.prototype.pay_button_text;
    /**
     * Unique transaction reference provided by the merchant
     * @type {?}
     */
    _RaveOptions.prototype.txref;
    /**
     * This is a sha256 hash of your getpaidSetup values, it is used for passing secured values to the payment gateway
     * @type {?}
     */
    _RaveOptions.prototype.integrity_hash;
    /**
     * The value to be passed for this is 1. This is useful when customer is using an opera browser, it would load the payment modal on a new page.
     * @type {?}
     */
    _RaveOptions.prototype.hosted_payment;
    /**
     * Any other custom data you wish to pass.
     * @type {?}
     */
    _RaveOptions.prototype.meta;
    /**
